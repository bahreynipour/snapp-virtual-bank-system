...
namespace App\Services\LockService;
...
final class TransactionLocker
{
     ...
     * @param QueryBuilder|EloquentBuilder|Model|null $query
     */
    public function __construct(Closure $closure, QueryBuilder|EloquentBuilder|Model|null $query = null)
    {
